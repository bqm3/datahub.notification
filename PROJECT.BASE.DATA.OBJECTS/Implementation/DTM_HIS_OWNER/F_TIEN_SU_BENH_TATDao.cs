...
{    
    public class F_TIEN_SU_BENH_TATDao : OracleBaseImpl<F_TIEN_SU_BENH_TAT>
    {        
		protected override void SetInfoDerivedClass()
        {
            TableName = "F_TIEN_SU_BENH_TAT";
            PackageName = "PK_F_TIEN_SU_BENH_TAT";
		...
		public List<F_TIEN_SU_BENH_TAT> GetList(Dictionary<string, object> dictParam)
        {
        ...
        public List<F_TIEN_SU_BENH_TAT> GetListPaging(Dictionary<string, object> dictParam, int pageIndex, int pageSize, ref int totalRecord)
        {            
            OracleParameter[] sqlParam = {				
                new OracleParameter("p_MA_BENH_NHAN",(dictParam != null && dictParam.ContainsKey("MA_BENH_NHAN")) ? dictParam["MA_BENH_NHAN"] : null),
                new OracleParameter("p_MA_CONG_DAN",(dictParam != null && dictParam.ContainsKey("MA_CONG_DAN")) ? dictParam["MA_CONG_DAN"] : null),
            ...
            List<F_TIEN_SU_BENH_TAT> result = this.ExecuteQuery("SP_GET_LIST_PAGING", sqlParam, pageIndex, pageSize, ref totalRecord);
            return result;
        }
