...
namespace PROJECT.BASE.ENTITY
{
    [Serializable]
    [DataContract]
    public partial class F_TIEN_SU_BENH_TAT
    {
    ...
    public partial class F_TIEN_SU_BENH_TAT_Request
    {
        [DataMember]
        [DisplayName("ID")]
        ...
        public F_TIEN_SU_BENH_TAT_Information Information { get; set; }

    }
    public partial class F_TIEN_SU_BENH_TAT_Information
    {
    ...
    public partial class F_TIEN_SU_BENH_TAT_Search
    {
