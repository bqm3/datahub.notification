...
namespace PROJECT.BASE.ENTITY
{
    [Serializable]
    [DataContract]
    public partial class D_CONG_DAN
    {
    ...
    public partial class D_CONG_DAN_Request
    {
        [DataMember]
        [DisplayName("ID")]
        ...
        public D_CONG_DAN_Information Information { get; set; }

    }
    public partial class D_CONG_DAN_Information
    {		
    ...
    public partial class D_CONG_DAN_Search
    {
