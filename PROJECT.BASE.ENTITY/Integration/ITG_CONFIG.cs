...
namespace PROJECT.BASE.ENTITY
{
    [Serializable]
    [DataContract]
    public partial class ITG_CONFIG
    {
        [DataMember]
        [SolrUniqueKey("ID")]
        [DisplayName("ID")]
    ...
    public partial class ITG_CONFIG_Request
    {
        [DataMember]
        [DisplayName("ID")]
        ...
        public ITG_CONFIG_Information Information { get; set; }

    }
    public partial class ITG_CONFIG_Information
    {
		[DataMember]		
		[DisplayName("CODE")]
		public string CODE { get; set; }
    ...
    public partial class ITG_CONFIG_Search
    {
