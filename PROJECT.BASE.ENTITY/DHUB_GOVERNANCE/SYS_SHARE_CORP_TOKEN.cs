...
namespace PROJECT.BASE.ENTITY
{
    [Serializable]
    [DataContract]
    public partial class SYS_SHARE_CORP_TOKEN
    {
        [DataMember]
        [SolrUniqueKey("ID")]
        [DisplayName("ID")]
        ...
        [DataMember]
        [SolrField("SERVICE_CODE")]
        [DisplayName("SERVICE_CODE")]
        public string SERVICE_CODE { get; set; }
        [DataMember]
        [SolrField("SERVICE_NAME")]
    ...
    public partial class SYS_SHARE_CORP_TOKEN_Request
    {
		[DataMember]
        [DisplayName("ID")]
    ...
    public partial class SYS_SHARE_CORP_TOKEN_Search
    {
