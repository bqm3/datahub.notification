...
namespace PROJECT.BASE.ENTITY
{
    [Serializable]
    [DataContract]
    public partial class SYS_CONFIG_WFLOW
    {
        [DataMember]
        [SolrUniqueKey("ID")]
        [DisplayName("ID")]
        ...
        [DataMember]
        [SolrField("ETL_TYPE")]
        [DisplayName("ETL_TYPE")]
        public short? ETL_TYPE { get; set; }
        [DataMember]
        [SolrField("NOTE")]
        [DisplayName("NOTE")]
    ...
    public partial class SYS_CONFIG_WFLOW_Request
    {
		[DataMember]
        [DisplayName("ID")]
    ...
    public partial class SYS_CONFIG_WFLOW_Search
    {
