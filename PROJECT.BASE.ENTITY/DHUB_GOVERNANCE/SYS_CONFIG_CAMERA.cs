...
namespace PROJECT.BASE.ENTITY
{
    [Serializable]
    [DataContract]
    public partial class SYS_CONFIG_CAMERA
    {
        [DataMember]
        [SolrUniqueKey("ID")]
        [DisplayName("ID")]
        ...
        [DataMember]
        [SolrField("CAM_NAME")]
        [DisplayName("CAM_NAME")]
        public string CAM_NAME { get; set; }
        [DataMember]
        [SolrField("URL_RTSP")]
        [DisplayName("URL_RTSP")]
        public string URL_RTSP { get; set; }
        [DataMember]
    ...
    public partial class SYS_CONFIG_CAMERA_Request
    {
		[DataMember]
        [DisplayName("ID")]
    ...
    public partial class SYS_CONFIG_CAMERA_Search
    {
