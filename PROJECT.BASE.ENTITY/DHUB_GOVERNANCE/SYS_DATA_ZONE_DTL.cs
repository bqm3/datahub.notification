...
namespace PROJECT.BASE.ENTITY
{
    [Serializable]
    [DataContract]
    public partial class SYS_DATA_ZONE_DTL
    {
        [DataMember]
        [SolrUniqueKey("ID")]
        [DisplayName("ID")]
        ...
        [DataMember]
        [SolrField("DATA_ZONE_CODE")]
        [DisplayName("DATA_ZONE_CODE")]
        public string DATA_ZONE_CODE { get; set; }
        [DataMember]
        [SolrField("IS_ACTIVE")]
    ...
    public partial class SYS_DATA_ZONE_DTL_Request
    {
		[DataMember]
        [DisplayName("ID")]
    ...
    public partial class SYS_DATA_ZONE_DTL_Search
    {
