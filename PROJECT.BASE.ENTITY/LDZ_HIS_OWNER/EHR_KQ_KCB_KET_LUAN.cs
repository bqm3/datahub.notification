...
namespace PROJECT.BASE.ENTITY
{
    [Serializable]
    [DataContract]
    public partial class EHR_KQ_KCB_KET_LUAN
    {
        [DataMember]
        [SolrUniqueKey("ID")]
        [DisplayName("ID")]
        ...
        [DataMember]
        [SolrField("MA_KET_LUAN")]
        [DisplayName("MA_KET_LUAN")]
        public string MA_KET_LUAN { get; set; }
        [DataMember]
        [SolrField("MA_KQ_KCB")]
    ...
    public partial class EHR_KQ_KCB_KET_LUAN_Request
    {
        [DataMember]
        [DisplayName("ID")]
        ...
        public EHR_KQ_KCB_KET_LUAN_Information Information { get; set; }

    }
    public partial class EHR_KQ_KCB_KET_LUAN_Information
    {
		[DataMember]		
		[DisplayName("CODE")]
		public string CODE { get; set; }
    ...
    public partial class EHR_KQ_KCB_KET_LUAN_Search
    {
