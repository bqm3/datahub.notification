...
namespace PROJECT.BASE.ENTITY
{
    [Serializable]
    [DataContract]
    public partial class EHR_DI_UNG
    {
        [DataMember]
        [SolrUniqueKey("ID")]
        [DisplayName("ID")]
        ...
        [DataMember]
        [SolrField("MA_DI_UNG_DON_VI")]
        [DisplayName("MA_DI_UNG_DON_VI")]
        public string MA_DI_UNG_DON_VI { get; set; }
        [DataMember]
        [SolrField("MA_HSSK")]
        [DisplayName("MA_HSSK")]
    ...
    public partial class EHR_DI_UNG_Request
    {
        [DataMember]
        [DisplayName("ID")]
        ...
        public EHR_DI_UNG_Information Information { get; set; }

    }
    public partial class EHR_DI_UNG_Information
    {
		[DataMember]		
		[DisplayName("CODE")]
		public string CODE { get; set; }
    ...
    public partial class EHR_DI_UNG_Search
    {
