...
namespace PROJECT.BASE.ENTITY
{
    ...
    public partial class LINE_CHART_Request
    {
        [DataMember]
        [DisplayName("CODE")]
        public string CODE { get; set; }
        ...
        public LINE_CHART_Information Information { get; set; }

    }
    public partial class LINE_CHART_Information
    {        
    ...
    public partial class LINE_CHART_SearchRequest
    {
